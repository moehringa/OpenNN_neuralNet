...
int main(int argc, const char** argv)
{
    ...
    string trainOrTest = getInput("Type train if you would like to train or test to test an existing NN and data set");
    ...
    if (trainOrTest == "train"){
        try {
            ...
            string inputFileName = getInput("Enter training filename without extension: ");

            string delimit = getInput("Enter separator type as Comma, Space, Tab..., : ");

            string outFileName = getInput("What should the output file be called?");
            ...
            string constructionType = getInput(
                    "Should a network be built from scratch or built on an existing network? Type scratch or existing.");
